...
- (void)drawRect:(CGRect)rect {
    ...
    CGFloat startLineX = (_direction == HYYSliderDirectionHorizonal ? _circleRadius : (self.frame.size.width - _lineWidth) / 2);
    CGFloat startLineY = (_direction == HYYSliderDirectionHorizonal ? (self.frame.size.height - _lineWidth) / 2 : _circleRadius);//起点
    
    CGFloat endLineX = (_direction == HYYSliderDirectionHorizonal ? self.frame.size.width - _circleRadius : (self.frame.size.width - _lineWidth) / 2);
    CGFloat endLineY = (_direction == HYYSliderDirectionHorizonal ? (self.frame.size.height - _lineWidth) / 2 : self.frame.size.height- _circleRadius);//终点
    ...
    CGFloat slidedLineX = (_direction == HYYSliderDirectionHorizonal ? MAX(_circleRadius, (_ratioNum * self.frame.size.width - _circleRadius)) : startLineX);
    
    CGFloat slidedLineY = (_direction == HYYSliderDirectionHorizonal ? startLineY : MAX(_circleRadius, (_ratioNum * self.frame.size.height - _circleRadius)));
    ...
    CGFloat circleX = (_direction == HYYSliderDirectionHorizonal ? MAX(_circleRadius + penWidth, slidedLineX - penWidth ) : startLineX);
    CGFloat circleY = (_direction == HYYSliderDirectionHorizonal ? startLineY : MAX(_circleRadius + penWidth, slidedLineY - penWidth));
...
- (void)updateTouchPoint:(NSSet*)touches {
    ...
    self.ratioNum = (_direction == HYYSliderDirectionHorizonal ? touchPoint.x : touchPoint.y) / (_direction == HYYSliderDirectionHorizonal ? self.frame.size.width : self.frame.size.height);
